...
import 'package:monirth_memories/ui/views/my_player/my_player_view.dart';
...
@MaterialAutoRouter(
  ...
  routes: <AutoRoute>[
    AutoRoute(
        ...
        // initial: true,
        guards: [NotAuthGuard]),
    AutoRoute(path: '/home', name: 'HomeRoute', initial: true, page: HomeView),
    AutoRoute(path: '/favorites', name: 'FavoritesRoute', page: FavoritesView),
    AutoRoute(path: '/full_image', name: 'FullImageRoute', page: FullImageView),
    AutoRoute(path: '/gallery', name: 'GalleryRoute', page: GalleryView),
    AutoRoute(path: '/video_list', name: 'VideoListRoute', page: VideoListView),
    AutoRoute(path: '/my_player', name: 'MyPlayerRoute', page: MyPlayerView),
  ],
)
class $AppRouter {}
